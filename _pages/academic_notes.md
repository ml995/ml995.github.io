...
3. 不等式：如果$\Sigma\in \mathbb{R}^{d\times d}$, $\lVert\Sigma^{-1}\rVert\le \frac{\lVert\Sigma\rVert^{d-1}}{|\det(\Sigma)|}$。[相关推特](https://twitter.com/miniapeur/status/1356026324733874181?s=20)。
